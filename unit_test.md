                                        ...
                                        - [Using Test Doubles](  # using-test-doubles)
                                            - [Parameterized Tests & Test Coverage](  # parameterized-tests--test-coverage)
                                              ...
                                              ```python
                                                ...
                                                self.phonebook.lookup(
                                                    "missing")

                                                # will sikp next module
                                                @unittest.skip("WIP")
                                              ...
                                              ```
                                                ...
                                                * Test case
                                                * Test Fixture
                                                * Unit Under Test(Test Runner) ![unit_test_suite](./images/Unit_test_suite.png) ![unit_test_vocabulary](./images/unittest_vab.png)
                                                ...
                                                * excutable: keeps in sync with the unit under test  # design the units
                                              ...
                                              ![design_unites](.\images\design_the _unites.png)
                                                ...
                                                * Organizing test code
                                                ...
                                                original unit testing like this: (not pythonic) ![test_case_class](.\images\tast_case_class.png)
